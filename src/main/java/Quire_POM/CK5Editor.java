...
//    @FindBy(xpath = "(//p)[1]")
    ...
    @FindBy(xpath = "//div[@id='comments-contentRegion-virtual']//div[@class='ck ck-annotation-wrapper ck-rounded-corners ck-annotation-wrapper--active']//div[@aria-label='Editor editing area: main']//p")
