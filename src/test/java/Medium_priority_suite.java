...
//        if (baseUrl.contains("app")) {
            driver.navigate().to("https://staging3.openquire.com/companies/253/company_features");
...
//        if (baseUrl.contains("staging5")) {
            driver.navigate().to("https://staging3.openquire.com/projects/654503/report_tags");
            Thread.sleep(2000);
//        } else if (baseUrl.contains("staging3") || baseUrl.contains("devops")) {
