...
public class ReportFolderSection extends ReusableAnnotations {
    ...
    public void enterSearchField_QA_Report() throws InterruptedException {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysandSubmitMethod(driver, searchFieldButton, "QA Automation Testing CK4 Folder-Chrome", logger, "QA automation Reports CK4 - search field-chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysandSubmitMethod(driver, searchFieldButton, "QA Automation Testing CK4 Folder-Firefox", logger, "QA automation Reports CK4 - search field-ff");
        }
    }
    ...
    public void clickAutomationReport_link() {
        ReusableMethodsLoggersPOM.scrollandClickMethod(driver, automationReport_link, logger, "automationReport_link");
    }
...
//            }
            ...
            BaseClass.reportfoldersection().enter_section_2_title_text();
...
//            BaseClass.staging5().verify_QP_CA_section();
            ...
            BaseClass.reportfoldersection().hover_and_click_section_2_checkbox();
            Thread.sleep(500);
            ...
            try {
                if (ok_button.isDisplayed()) {
                    BaseClass.reportfoldersection().click_ok_button();
...
//    }
    ...
    //old ck4 - updated 12/5/25 w new method
    public void ck4PackagesCheck_old() throws InterruptedException {
int linkItemCount = linkItem.size();
