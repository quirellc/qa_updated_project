...
public class ProjectFolderSection extends ReusableAnnotations {
    ...
    public void enterProjectFolderNameField_PCA() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing PCA CK4 Project Folder-Chrome "+  dateOfSystem, logger, "PCA Project Folder name field chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing PCA CK4 Project Folder-Firefox "+ dateOfSystem, logger, "PCA Project Folder name field ff");
        }}

    public void enterProjectFolderNameField_ESA() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing ESA CK4 Project Folder-Chrome "+  dateOfSystem, logger, "ESA Project Folder name field chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing ESA CK4 Project Folder-Firefox "+ dateOfSystem, logger, "ESA Project Folder name field ff");
        }}
    ...
    public void enterProjectFolderNameField_SRA() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing SRA CK4 Project Folder-Chrome "+  dateOfSystem, logger, "SRA Project Folder name field chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing SRA CK4 Project Folder-Firefox "+ dateOfSystem, logger, "SRA Project Folder name field ff");
        }}

    public void enterProjectFolderNameField_FM_1104() {
        if (browserName.contains("Chrome")) {
        ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing Freddie Mac 1104 CK4 Project Folder-Chrome "+  dateOfSystem, logger, "1104 Project Folder name field chrome");
    } else if (browserName.contains("Firefox")) {
        ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing Freddie Mac 1104 CK4 Project Folder-Firefox "+ dateOfSystem, logger, "1104 Project Folder name field ff");
    }}

    public void enterProjectFolderNameField_FM_1105() {
        ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing Freddie Mac 1105 CK4 Project Folder_" + dateOfSystem, logger, "SRA Project Folder name field");
    }

    public void enterProjectFolderNameField_CK5() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing CK4 Project Folder-Chrome "+  dateOfSystem, logger, "CK4 Project Folder name field chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing CK4 Project Folder-Firefox "+ dateOfSystem, logger, "CK4 Project Folder name field ff");
        }
}
    ...
    public void enterProjectFolderNameField_ZON() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing ZON CK4 Project Folder-Chrome "+  dateOfSystem, logger, "ZON Project Folder name field chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing ZON CK4 Project Folder-Firefox "+ dateOfSystem, logger, "ZON Project Folder name field ff");
        }}

    public void enterProjectFolderNameField_Medium() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing Medium Priority CK4 Project Folder-Chrome "+  dateOfSystem, logger, "Medium Priority Project Folder name field chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, projectFolderName, "QA Automation Testing Medium Priority CK4 Project Folder-Firefox "+ dateOfSystem, logger, "Medium Priority Project Folder name field ff");
        }}
    ...
    @FindBy(xpath = "//*[contains(text(),'PCA CK4 Template-Chrome')]")
    WebElement projectFolder_QA_PCA_Template_chrome;
    @FindBy(xpath = "//*[contains(text(),'PCA CK4 Template-Firefox')]")
    WebElement projectFolder_QA_PCA_Template_firefox;
    public void click_PCA_Template_projectFolder_templatesTab() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.scrollandClickMethod(driver, projectFolder_QA_PCA_Template_chrome, logger, "QA PCA template chrome");
        } else if (browserName.contains("Firefox")) {
...
//    WebElement projectFolder_ESA_Template_ff;
    public void click_ESA_Template_projectFolder_templatesTab() {
            ReusableMethodsLoggersPOM.scrollandClickMethod(driver, projectFolder_ESA_Template, logger, "QA esa template");
        }

    @FindBy(xpath = "//div[contains(text(),'FM_1104 CK4 Template-Chrome')]")
    WebElement projectFolder_FM_1104_Template_chrome;
    @FindBy(xpath = "//div[contains(text(),'FM_1104 CK4 Template-Firefox')]")
    WebElement projectFolder_FM_1104_Template_ff;
    public void click_FM_1104_Template_projectFolder_templatesTab() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.scrollandClickMethod(driver, projectFolder_FM_1104_Template_chrome, logger, "QA fm1104 template chrome");
        } else if (browserName.contains("Firefox")) {
...
//    }
    ...
    @FindBy(xpath = "//*[contains(text(),'SRA CK4 Template-Chrome')]")
    WebElement projectFolder_SRA_Template_chrome;
    @FindBy(xpath = "//*[contains(text(),'SRA CK4 Template-Firefox')]")
    WebElement projectFolder_SRA_Template_ff;
    public void click_SRA_Template_projectFolder_templatesTab() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.scrollandClickMethod(driver, projectFolder_SRA_Template_chrome, logger, "QA sra template chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.scrollandClickMethod(driver, projectFolder_SRA_Template_ff, logger, "QA sra template firefox");
        }}

    @FindBy(xpath = "//*[contains(text(),'ZON CK4 Template-Chrome')]")
    WebElement projectFolder_ZON_Template_chrome;
    @FindBy(xpath = "//*[contains(text(),'ZON CK4 Template-Firefox')]")
    WebElement projectFolder_ZON_Template_ff;
    public void click_ZON_Template_projectFolder_templatesTab() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.scrollandClickMethod(driver, projectFolder_ZON_Template_chrome, logger, "QA zon template chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.scrollandClickMethod(driver, projectFolder_ZON_Template_ff, logger, "QA zon template firefox");
        }}

    @FindBy(xpath = "//div[contains(text(),'CK4 Template-Chrome')]")
    WebElement projectFolder_CK4_Template_chrome;
    @FindBy(xpath = "//div[contains(text(),'CK4 Template-Firefox')]")
    WebElement projectFolder_CK4_Template_ff;
    public void click_CK5_Template_projectFolder_templatesTab() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.scrollandClickMethod(driver, projectFolder_CK4_Template_chrome, logger, "QA ck4 template chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.scrollandClickMethod(driver, projectFolder_CK4_Template_ff, logger, "QA ck4 template firefox");
        }}
    ...
    @FindBy(xpath = "//span[contains(text(),'PCA CK4 Project Folder-Firefox')]")
    WebElement projectFolder_PCA_Link_ff;
    @FindBy(xpath = "//span[contains(text(),'PCA CK4 Project Folder-Chrome')]")
    ...
    @FindBy(xpath = "//span[contains(text(),'ESA CK4 Project Folder-Firefox')]")
    WebElement projectFolder_ESA_Link_ff;
    @FindBy(xpath = "//span[contains(text(),'ESA CK4 Project Folder-Chrome')]")
    ...
    @FindBy(xpath = "//*[contains(text(),'SRA CK4 Project Folder-Chrome')]")
    WebElement projectFolder_SRA_Link_chrome;
    @FindBy(xpath = "//*[contains(text(),'SRA CK4 Project Folder-Firefox')]")
    ...
    @FindBy(xpath = "//span[contains(text(),'Testing CK4 Project Folder-Chrome')]")
    WebElement projectFolder_CK5_Link_chrome;
    @FindBy(xpath = "//span[contains(text(),'Testing CK4 Project Folder-Firefox')]")
    WebElement projectFolder_CK5_Link_ff;

    public void click_CK5_ProjectFolderLink() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.clickMethod(driver, projectFolder_CK5_Link_chrome, logger, "project folder ck4 link chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.clickMethod(driver, projectFolder_CK5_Link_ff, logger, "project folder ck4 link ff");
        }}
    ...
    @FindBy(xpath = "//span[contains(text(),'ZON CK4 Project Folder-Chrome')]")
    WebElement projectFolder_ZON_Link_chrome;
    @FindBy(xpath = "//span[contains(text(),'ZON CK4 Project Folder-Firefox')]")
    ...
    @FindBy(xpath = "//span[contains(text(),'Freddie Mac 1104 CK4 Project Folder-Chrome')]")
    WebElement projectFolder_FM_1104_Link_chrome;
    @FindBy(xpath = "//span[contains(text(),'Freddie Mac 1104 CK4 Project Folder-Firefox')]")
    ...
    @FindBy(xpath = "//*[contains(text(),'Medium Priority CK4 Project Folder-Chrome')]")
    WebElement projectFolder_medium_priority_Link_chrome;
    @FindBy(xpath = "//*[contains(text(),'Medium Priority CK4 Project Folder-Firefox')]")
