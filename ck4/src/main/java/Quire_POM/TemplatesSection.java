...
public class TemplatesSection extends ReusableAnnotations {
    ...
    @FindBy(xpath = "//div[@class='ui-menu-item-wrapper'][contains(text(),'QA Automation Testing New Updated Medium Priority  CK4 Template-Chrome')]")
    WebElement medium_priority_updated_dropdownValue_chrome;
    @FindBy(xpath = "//div[@class='ui-menu-item-wrapper'][contains(text(),'QA Automation Testing New Updated Medium Priority  CK4 Template-Firefox')]")
...
//            ReusableMethodsLoggersPOM.verifyBooleanStatement(driver, export_completed_arrow,true,  logger, "export_completed_arrow");}
    ...
    @FindBy(xpath = "//div[contains(text(),'Automation WB Item')] | //div[contains(text(),'Accessibility')]")
    WebElement exported_wb_item_1;
    @FindBy(xpath = "//div[contains(text(),'ck4 wb item')] | //div[contains(text(),'Accessibility')]")
    ...
    public void enter_Medium_projFolder_to_template() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysandSubmitMethod(driver, unassigned_items_searchField, "QA Automation Testing Medium Priority CK4 Project Folder-Chrome", logger, " unassigned_items_searchField ");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysandSubmitMethod(driver, unassigned_items_searchField, "QA Automation Testing Medium Priority CK4 Project Folder-Firefox", logger, " unassigned_items_searchField ");
        }
    ...
    public void enterTemplateNameField_FM_1104() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing FM_1104 CK4 Template-Chrome", logger, "FreddieMac1104 template name field Chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing FM_1104 CK4 Template-Firefox", logger, "FreddieMac1104 template name field Firefox");
        }}
    public void enterTemplateNameField_FM_1105() {
        if (browserName.contains("Chrome")) {
        ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing FM_1105 CK4 Template-Chrome", logger, "FreddieMac1105 template name field Chrome");

    } else if (browserName.contains("Firefox")) {
        ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing FM_1105 CK4 Template-Firefox", logger, "FreddieMac1105 template name field Firefox");
    }}
    public void enterTemplateNameField_cloned_FM_1105() {
        if (browserName.contains("Chrome")) {
        ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing FM_1105 CK4 Cloned Template-Chrome", logger, "FreddieMac1105 template name field Chrome");

    } else if (browserName.contains("Firefox")) {
        ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing FM_1105 CK4 Cloned Template-Firefox", logger, "FreddieMac1105 Cloned template name field Firefox");
    }}
    public void enterTemplateNameField_PCA() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing PCA CK4 Template-Chrome", logger, "PCA template name field chrome");

        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing PCA CK4 Template-Firefox", logger, "PCA template name field ff");
        }
    }
...
//}
    public void enterTemplateNameField_SRA() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing SRA CK4 Template-Chrome", logger, "SRA template name field chrome");

        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing SRA CK4 Template-Firefox", logger, "SRA template name field ff");
        }}

    public void enterTemplateNameField_ck5() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing CK4 Template-Chrome", logger, "CK5 template name field chrome");

        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing CK4 Template-Firefox", logger, "CK5 template name field ff");
        }}
...
//        }}
    ...
    public void enterTemplateNameField_ZON() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing ZON CK4 Template-Chrome", logger, "ZON template name field chrome");

        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing ZON CK4 Template-Firefox", logger, "ZON template name field ff");
        }}
    public void enterTemplateNameField_medium_priority() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing Medium Priority CK4 Template-Chrome", logger, "Medium Priority Template chrome");

        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing Medium Priority CK4 Template-Firefox", logger, " Medium Priority Template ff");
        }}

    public void enter_TemplateNameField_cloned_medium_priority() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing Cloned Medium Priority CK4 Template-Chrome", logger, "Cloned Medium Priority Template chrome");

        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, templateName, "QA Automation Testing Cloned Medium Priority CK4 Template-Firefox", logger, "Cloned Medium Priority Template ff");
        }}
    ...
    public void delete_automation_templates() throws InterruptedException {
        BaseClass.templatesSection().enterSearchField_automated_templates();
        Thread.sleep(6000);
    ...
    public void enterSearchField_automated_templates() throws InterruptedException {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, search_field, "CK4 Template-Chrome", logger, "Chrome files");
            Thread.sleep(1000);
            ReusableMethodsLoggersPOM.submitMethod(driver, search_field,  logger, "Chrome files");


        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, search_field, "CK4 Template-Firefox", logger, "Firefox files");
            Thread.sleep(1000);
    ...
    public void enterSearchField_automated_files() throws InterruptedException {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, search_field, "CK4 Project Folder-Chrome", logger, "Chrome files");
            Thread.sleep(1000);
            ReusableMethodsLoggersPOM.submitMethod(driver, search_field,  logger, "Chrome files");


        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysMethod(driver, search_field, "CK4 Project Folder-Firefox", logger, "Firefox files");
            Thread.sleep(1000);
...
//        ReusableMethodsLoggersPOM.sendKeysandSubmitMethod(driver, search_field, "QA Automation Testing ESA Template", logger, "ESA template search_field ");}
    ...
    public void enterTemplateSearchField_ZON() {
        ...
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysandSubmitMethod2(driver, search_field, "QA Automation Testing Medium Priority CK4 Template-Chrome", logger, " QA Automation Testing New Updated Medium Priority Template-chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysandSubmitMethod2(driver, search_field, "QA Automation Testing Medium Priority CK4 Template-Firefox", logger, " QA Automation Testing New Updated Medium Priority Template-ff");
        }
        ReusableMethodsLoggersPOM.submitMethod(driver, search_field, logger, "search_field ");}
    public void enterTemplateSearchField_updated_medium() {
        if (browserName.contains("Chrome")) {
            ReusableMethodsLoggersPOM.sendKeysandSubmitMethod2(driver, search_field, "QA Automation Testing New Updated Medium Priority CK4 Template-Chrome", logger, " QA Automation Testing New Updated Medium Priority Template-chrome");
        } else if (browserName.contains("Firefox")) {
            ReusableMethodsLoggersPOM.sendKeysandSubmitMethod2(driver, search_field, "QA Automation Testing New Updated Medium Priority CK4 Template-Firefox", logger, " QA Automation Testing New Updated Medium Priority Template-ff");
        }
        ReusableMethodsLoggersPOM.submitMethod(driver, search_field, logger, " search_field ");}
    ...
    @FindBy(xpath = "//section[contains(@class,'intro-section') and contains(@class,'editor-section') and contains(@class,'lockable') and contains(@class,'js-spellCheckContent')]")
    ...
    @FindBy(xpath = "//div[contains(@class, 'contentTag') and contains(@class, 'widget')]")
...
//    }
   ...
   WebElement yellow_instruction_icon_introPage;
    ...
    @FindBy(xpath = "//li[@class='list-group-item'][normalize-space()='QA Automation Testing FM_1104 CK4 Template-Chrome']")
    WebElement clone_existing_template_first_fm_1104_dropdown_chrome;
    @FindBy(xpath = "//li[@class='list-group-item'][normalize-space()='QA Automation Testing FM_1104 CK4 Template-Firefox']")
