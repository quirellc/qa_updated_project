...
//        softAssert.assertAll();
    ...
    @FindBy(xpath = "//div[@id='widget-myCompanies']//a[contains(normalize-space(),'QATE')]")
    WebElement contractor_Quire_Automated_Testing_Environment_link;

    public void  click_contractor_Quire_Automated_Testing_Environment_link() {
        ReusableMethodsLoggersPOM.clickMethod(driver, contractor_Quire_Automated_Testing_Environment_link, logger, "contractor_Quire_Automated_Testing_Environment_link");
    }
