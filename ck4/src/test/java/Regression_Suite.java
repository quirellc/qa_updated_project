...
//        driver.navigate().to("https://staging5-next.openquire.com/");
    ...
    @Test
    public void TR_005c_ck4_and_uploadtoProfile_current_admin_login() throws InterruptedException {
...
//
    ...
    @Test
    public void TR_007a_lock_unlock_ck4() throws InterruptedException {
...
//    skipping since ck5 already does this
//    @Test
...
//    }
    @Test
    public void TR_008_ck4_dashboard_author_login() throws InterruptedException {
        BaseClass.staging5().clickUserProfileTab();
        BaseClass.staging5().click_userProfileTab_logOut_dropdownItem();
    ...
    @Test
    public void TR_009_ck4_dashboard_editor_login() throws InterruptedException {
        BaseClass.staging5().clickUserProfileTab();
        BaseClass.staging5().click_userProfileTab_logOut_dropdownItem();
    ...
    @Test
    public void TR_010_ck4_dashboard_PM_login() throws InterruptedException {
        BaseClass.staging5().clickUserProfileTab();
        BaseClass.staging5().click_userProfileTab_logOut_dropdownItem();
    ...
    @Test
    public void TR_011_ck4_root_login() throws InterruptedException {
        BaseClass.staging5().clickUserProfileTab();
        BaseClass.staging5().click_userProfileTab_logOut_dropdownItem();
...
//        }
    ...
    @Test
    public void TR_012_ck4_dashboard_contractor_login() throws InterruptedException {
        BaseClass.staging5().clickUserProfileTab();
        BaseClass.staging5().click_userProfileTab_logOut_dropdownItem();
...
//        Thread.sleep(1000);
        ...
        BaseClass.dashBoard().click_contractor_Quire_Automated_Testing_Environment_link();
...
//        BaseClass.staging5().clickSection_row_editor();
    ...
    @Test
    public void TR_013_ck4_sysadmin_login_analytics_check() throws InterruptedException {
        BaseClass.staging5().clickUserProfileTab();
        BaseClass.staging5().click_userProfileTab_logOut_dropdownItem();
        ...
        driver.navigate().to("https://staging3.openquire.com/analytics");
        Thread.sleep(1000);
        BaseClass.quireLogin().VERIFY_NO_something_went_wrong_MESSAGE();
        Thread.sleep(1000);
        driver.navigate().to("https://staging3.openquire.com/dashboard");
