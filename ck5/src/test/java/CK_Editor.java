...
public class CK_Editor extends ReusableAnnotations {
    ...
    @Test
    public void TR_0001_user_login() throws InterruptedException {
        WebDriver driver = getDriver();
...
//        driver.navigate().to("https://staging5-next.openquire.com/");
    ...
    @Test
    public void TR_0002_createTemplate() throws InterruptedException {
...
//        BaseClass.reporttagssection().hover_to_ReportTags_sections_Button();
    ...
    @Test
    public void TR_0004_spellcheck_intro_pages_template() throws InterruptedException{
    ...
    @Test
    public void TR_0005_Template_instructionText_wordBank() throws InterruptedException {
...
//wordBank details
    ...
    @Test
    public void TR_0005a_create_ST() throws InterruptedException {
...
//           Thread.sleep(500);
    ...
    @Test
    public void TR_0005b_create_assign_WB_PM_user() throws InterruptedException {
...
//add refresh for semaphore   for      BaseClass.staging5().click_number_dropDown_dynamic_cell();
    ...
    @Test
    public void TR_0005c_dynamic_column_cells_PM_user() throws InterruptedException {
        WebDriver driver = getDriver();
...
//        Thread.sleep(500);
    ...
    @Test
    public void TR_0006_new_ck5_report_creation() throws InterruptedException{
    ...
    @Test
    public void TR_0007_generate_and_email_PDF_Link() throws InterruptedException, IOException {
        WebDriver driver = getDriver();
//generate pdf
