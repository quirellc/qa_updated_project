...
public class SanityCheck_Staging extends ReusableAnnotations {

// new

    @Test
    public void TC_001_staging_login() throws InterruptedException {
...
//
    ...
    @Test
    public void TC_002_open_reports() throws InterruptedException {
...
//
    ...
    @Test
    public void TC_003_generatePDF() throws InterruptedException {
    ...
    @Test
    public void TC_004_appendices() throws InterruptedException {
        WebDriver driver = getDriver();
  ...
  //      BaseClass.reportfoldersection().capture_processing_gallery_items_appendix_section();
   //     Thread.sleep(500);
    ...
    @Test
    public void TC_005_templates() throws InterruptedException {
    ...
    @Test
    public void TC_006_portfolios() throws InterruptedException {
        WebDriver driver = getDriver();
    ...
    @Test
    public void TC_007_shared_reports() throws InterruptedException {
        WebDriver driver = getDriver();
    ...
    @Test
    public void TC_008_pdf_Link_emails() throws InterruptedException {
    ...
    @Test
    public void TC_009_wordBank_libraries() throws InterruptedException {
    ...
    @Test
    public void TC_010_PDF_File_Name_Formats() throws InterruptedException {
    ...
    @Test
    public void TC_011_Company_Users() throws InterruptedException {
    ...
    @Test
    public void TC_012_Contractors() throws InterruptedException {
    ...
    @Test
    public void TC_013_Spellcheck_trackChanges_ck4() throws InterruptedException {
        WebDriver driver = getDriver();

        //navigate to empty report
        driver.navigate().to("https://staging5.openquire.com/reports/666366");
        Thread.sleep(500);
        BaseClass.staging5().captureURL();
        Thread.sleep(500);
...
//        BaseClass.staging5().capture_spellCheck_errors();
    ...
    @Test
    public void TR_014_portfolios_filterByTemplate() throws InterruptedException, IOException {
        WebDriver driver = getDriver();
        ...
        Thread.sleep(500);
        BaseClass.staging5().verify_report_names_from_qa_portfolio_PDF();
        Thread.sleep(500);
    }

    @Test
    public void TR_015_dashboard_contractor_login() throws InterruptedException {
    ...
    @Test
    public void TR_016_analytics_page_check() throws InterruptedException {
        ...
        Thread.sleep(500);
        driver.navigate().to("https://staging5.openquire.com/dashboard");
        BaseClass.staging5().clickUserProfileTab();
        BaseClass.staging5().click_userProfileTab_logOut_dropdownItem();
        Thread.sleep(500);
        driver.navigate().to("https://staging5.openquire.com/analytics");
